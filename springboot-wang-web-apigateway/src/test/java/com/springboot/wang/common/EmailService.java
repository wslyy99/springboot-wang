...
public class EmailService extends SpringbootWangWebApplicationTests {
    ...
    public void sendSimpleEmail(){
        ...
        message.setFrom("804823193@qq.com");//发送者.
        message.setTo("wslyy99@163.com.com");//接收者.
    ...
    public void sendAttachmentsEmail() throws MessagingException {
        ...
        //基本设置.
        helper.setFrom("804823193@qq.com");//发送者.
        helper.setTo("wslyy99@163.com.com");//接收者.
